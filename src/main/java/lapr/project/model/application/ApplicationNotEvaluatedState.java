...
/**
 * Represents the not evaluated state for application.
 *
 ...
 */
public class ApplicationNotEvaluatedState implements ApplicationState {
     ...
     */
    public ApplicationNotEvaluatedState(Application application) {
