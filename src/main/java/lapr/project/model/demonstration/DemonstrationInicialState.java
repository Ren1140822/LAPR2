...
/**
 * Represents the inicial state of a demonstration.
 *
 ...
 */
public class DemonstrationInicialState implements DemonstrationState, Serializable {
    ...
    /**
     * Default constructor of a demonstration's inicial state.
     *
     * @param demonstration Demonstration to change state
     */
    public DemonstrationInicialState(Demonstration demonstration) {
    ...
    public boolean validate() {
        return this.demonstration.validate();
    }
}
