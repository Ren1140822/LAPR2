 ...
 */
public class DemonstrationApplicationsInEvaluationState implements DemonstrationState {
    ...
    /**
     * Default constructor of an demonstration's applications in evaluation
     * state.
     *
     * @param demonstration Demonstration to change state
     */
    public DemonstrationApplicationsInEvaluationState(Demonstration demonstration) {
    ...
    public boolean setApplicationsInDecision() {
        if (validate()) {
            demonstration.setCurrentState(new DemonstrationApplicationsInDecisionState(demonstration));
            return true;
        }
        return false;
    }
