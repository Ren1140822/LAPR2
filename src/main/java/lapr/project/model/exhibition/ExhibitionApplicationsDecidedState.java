...
/**
 * Represents the applications decided state of a exhibition.
 *
 ...
 */
public class ExhibitionApplicationsDecidedState implements ExhibitionState {
     ...
     */
    public ExhibitionApplicationsDecidedState(Exhibition exhibition) {
    ...
    public boolean validate() {
        ...
        return this.exhibition.getState().isApplicationsDecided();
    }
}
